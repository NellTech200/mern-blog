...
export default function DashProfile() {
    ...
    const [showModal, setShowModal] = useState(false);  //this is to delete a user 
    ...
    const uploadImage = async () => {
        ...
        const storage = getStorage(app); //this is gotten from the firebase file
        ...
        uploadTask.on(
            ...
            (snapshot) => {
                ...
                getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
                    ...
                    setFormData({ ...formData, profilePicture: downloadURL }); //we are using the spread operator to keep the previous information from the form list
                    setImageFileUploading(false);
                });
            }
        )
